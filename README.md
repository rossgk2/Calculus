...
The first half of calculus is about computing change from quantity, and the second half is about computing quantity from change; **clearly, the two halves are inverse processes**. Specifically, the difference in quantity $f(b) - f(a)$ is produced by   sum 
